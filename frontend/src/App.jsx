      ...
      <Router>
        <div className="min-h-screen bg-gradient-to-br from-white to-yellow-200">
          ...
          <Toaster 
            ...
            toastOptions={{
              duration: 4000,
              style: { background: '#fff', color: '#1f2937', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '12px 16px', fontSize: '14px', fontWeight: '500' },
              success: { style: { background: '#f0fdf4', color: '#166534', border: '1px solid #bbf7d0' } },
              error: { style: { background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca' } },
              loading: { style: { background: '#fffbeb', color: '#d97706', border: '1px solid #fed7aa' } }
            }}
          />
